...
const BudgetPage = () => {
  ...
  // Filter out income categories for modal dropdown
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              <h1 className="text-3xl font-bold" style={{ color: jonyColors.textPrimary }}>
                Budget
              </h1>
          ...
          <div className="p-8 rounded-2xl border" style={{
            ...
            <div className="mb-6">
              {(summary.overBudgetCount > 0 || summary.warningCount > 0) && (
                <div className="flex items-center gap-4 text-sm mb-4 p-3 rounded-lg" style={{
                  backgroundColor: jonyColors.cardBackground
                }}>
                  {summary.overBudgetCount > 0 && (
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full" style={{ backgroundColor: jonyColors.red }}/>
                      <span style={{ color: jonyColors.textPrimary }}>{summary.overBudgetCount} über Budget</span>
                    </div>
                  )}
                  {summary.warningCount > 0 && (
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full" style={{ backgroundColor: jonyColors.orange }}/>
                      <span style={{ color: jonyColors.textPrimary }}>{summary.warningCount} Warnung</span>
                    </div>
                  )}
                </div>
              )}
            ...
            {budgetData.map((budget) => (
              <div key={budget.id} className="group relative p-4 rounded-xl border transition-all duration-200 hover:shadow-sm" style={{
                backgroundColor: jonyColors.surface,
                border: `1px solid ${jonyColors.border}`
              }}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-semibold text-lg" style={{ color: jonyColors.textPrimary }}>
                        {budget.category}
                      </h3>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 max-w-xs">
                        <div className="w-full rounded-full h-2" style={{ backgroundColor: jonyColors.cardBackground }}>
                          <div 
                            className="h-2 rounded-full transition-all duration-500"
                            style={{ 
                              width: `${Math.min(100, budget.progressPercentage)}%`,
                              backgroundColor: budget.status === 'over' ? jonyColors.red :
                  ...
                  <div className="text-right mr-4">
                    <div className="text-sm font-medium" style={{ color: jonyColors.textPrimary }}>
